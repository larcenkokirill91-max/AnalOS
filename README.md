...
**Что нужно сделать:**
Нужна легковесная библиотека на C или C++ для отрисовки базовых элементов интерфейса. Вы работаете с готовым холстом.
...
* Для низкоуровневых хардкорщиков (Asm/C): Нужно провести аудит обработчиков прерываний в IDT и помочь пофиксить баги. .
