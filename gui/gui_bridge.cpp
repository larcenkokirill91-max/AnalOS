...
int cpp_get_window_x(int idx) { return win[idx].get_x(); }
int cpp_get_window_y(int idx) { return win[idx].get_y(); }
int cpp_get_window_width(int idx) { return win[idx].get_width(); }
int cpp_get_window_height(int idx) { return win[idx].get_height(); }
}